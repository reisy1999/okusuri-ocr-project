...
const VERTICAL_COLOR = "rgba(99, 102, 241, 0.6)"   // indigo
const HORIZONTAL_COLOR = "rgba(16, 185, 129, 0.6)"  // emerald

export function ResultView({ lines, imageUrl }: ResultViewProps) {
    ...
    <div className="grid gap-4 lg:grid-cols-2">
      <Card>
        <CardHeader className="pb-2">
          <CardTitle className="text-base">検出結果</CardTitle>
      ...
      <Card>
        <CardHeader className="pb-2">
          <CardTitle className="text-base">認識テキスト</CardTitle>
        </CardHeader>
        <CardContent>
